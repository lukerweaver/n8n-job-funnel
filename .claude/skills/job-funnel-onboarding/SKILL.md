...
description: Guide a user through first-time Job Funnel setup, including app health checks, onboarding fields, AI provider setup, targeted resumes, and Chrome extension ingest. Use when the user asks how to set up or onboard Job Funnel.
---
